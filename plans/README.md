...
| [011](011-provision-fail-closed-cuda-smoke.md) | Provision a fail-closed CUDA environment and close the upstream smoke | P1 | M | 009 | BLOCKED: no CUDA host; current shell has no torch |
